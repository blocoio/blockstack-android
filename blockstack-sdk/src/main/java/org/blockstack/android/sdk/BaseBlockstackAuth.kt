...
open class BaseBlockstackAuth(private val sessionStore: ISessionStore, private val appConfig: BlockstackConfig, private val appDetails: AppDetails? = null) {
     ...
     *
     */
    open suspend fun redirectToSignInWithAuthRequest(context: Context, authRequest: String, blockstackIDHost: String? = null, sendToSignIn: Boolean = false) {
